...
public class JoinAllMeetingRequest {
	...
	public String toString() {
		return "JoinAllMeetingRequest [fullName=" + fullName + ", meetingID=" + meetingID + ", moderatorPassword="
				+ moderatorPassword + ", attendeePassword=" + attendeePassword + ", createTime=" + createTime
				+ ", userID=" + userID + ", webVoiceConf=" + webVoiceConf + ", configToken=" + configToken
				+ ", defaultLayout=" + defaultLayout + ", avatarURL=" + avatarURL + ", redirect=" + redirect
				+ ", clientURL=" + clientURL + ", joinViaHtml5=" + joinViaHtml5 + ", guest=" + guest + "]";
	}
